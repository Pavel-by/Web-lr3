...
$(document).ready(function () {
  let update = async function () {
    ...
    let html = "";
    if (users == null) html = `<div class='uk-alert uk-alert-warning'>Не удалось загрузить список участников аукциона</div>`;
    if (users === 0) html = `<div class='uk-alert uk-alert-primary'>Список пользователей пуст</div>`;else {
      users.forEach(user => {
