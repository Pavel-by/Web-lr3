...
$(document).ready(function () {
  ...
  async function refreshAuctionInfo() {
    ...
    if (auction === null) return block.html(`<div uk-alert class="uk-alert-warning">Не удалось загрузить данные об аукционе</div>`);
    let html = "";
    ...
    if ((user === null || user === void 0 ? void 0 : user.isadmin) === true) html += `<div class='uk-margin'><a type="button" class="uk-button uk-button-default" href="/auction/edit">Редактировать</a></div>`;
    block.html(html);
  }
});