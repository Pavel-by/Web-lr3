...
$(document).ready(function () {
  let refresh = async function () {
    ...
    let html = "";
    if (auction == null || user == null) html = `<div class='uk-alert uk-alert-warning'>Не удалось загрузить список лотов аукциона</div>`;else if (auction.pictures.length === 0) html = `<div class='uk-alert uk-alert-primary'>Список лотов пуст</div>`;else {
      for (let i = 0; i < auction.pictures.length; i++) {
        ...
        let filename = (picture === null || picture === void 0 ? void 0 : picture.filename) || "";
    ...
    if ((user === null || user === void 0 ? void 0 : user.isadmin) === true) html += `<a class='uk-button uk-button-default' href="/auction/lot/edit">Редактировать</a>`;
    element.html(html);
  };
